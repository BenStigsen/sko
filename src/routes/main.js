...
const products = [
    { name: 'Nike Air Force 1', price: 90.00 },
    { name: 'Adidas Superstar', price: 80.00 },
    { name: 'Converse Chuck Taylor All Star', price: 55.00 },
    { name: 'Vans Old Skool', price: 60.00 },
    { name: 'New Balance 574', price: 80.00 },
    { name: 'Puma Suede Classic', price: 65.00 },
    { name: 'Reebok Classic Leather', price: 75.00 },
    { name: 'Air Jordan 1', price: 170.00 },
    { name: 'Yeezy Boost 350', price: 220.00 },
    { name: 'Asics Gel-Lyte III', price: 110.00 },
    { name: 'Saucony Jazz Original', price: 60.00 },
    { name: 'Brooks Adrenaline GTS', price: 130.00 },
    { name: 'Hoka One One Clifton', price: 130.00 },
    { name: 'Mizuno Wave Rider', price: 120.00 },
    { name: 'Under Armour HOVR Phantom', price: 130.00 },
    { name: 'Salomon Speedcross', price: 130.00 },
    { name: 'Merrell Moab 2', price: 120.00 },
    { name: 'Keen Targhee II', price: 135.00 },
    { name: 'Columbia Newton Ridge Plus II', price: 90.00 },
    { name: 'Timberland White Ledge', price: 80.00 },
    { name: 'Dr. Martens 1460', price: 150.00 },
    { name: 'Clarks Desert Boot', price: 130.00 },
    { name: 'UGG Classic Short', price: 170.00 },
    { name: 'Frye Harness 12R', price: 328.00 },
    { name: 'Sorel Caribou', price: 170.00 },
    { name: 'LL Bean Bean Boot', price: 129.00 },
    { name: 'Red Wing Iron Ranger', price: 330.00 },
    { name: 'Wolverine 1000 Mile', price: 385.00 },
    { name: 'Thorogood American Heritage', price: 220.00 },
    { name: 'Chippewa Original', price: 270.00 },
    { name: 'Justin Original Workboots', price: 180.00 },
    { name: 'Ariat Heritage Roper', price: 140.00 },
    { name: 'Tony Lama TLX Waterproof', price: 200.00 },
    { name: 'Carhartt Rugged Flex', price: 160.00 },
    { name: 'Georgia Giant Romeo', price: 110.00 },
    { name: 'Danner Mountain Light II', price: 380.00 },
    { name: 'La Sportiva Wildcat', price: 130.00 },
    { name: 'Scarpa Zodiac Plus GTX', price: 280.00 },
    { name: 'Salewa Mountain Trainer', price: 200.00 },
    { name: 'Lowa Renegade GTX', price: 240.00 },
    { name: 'Altra Lone Peak', price: 130.00 },
    { name: 'Brooks Cascadia', price: 130.00 },
    { name: 'Inov-8 Roclite', price: 140.00 },
    { name: 'Nike Zoom Terra Kiger', price: 140.00 },
    { name: 'Salomon Speedcross', price: 130.00 },
    { name: 'La Sportiva Bushido', price: 130.00 },
    { name: 'Adidas Terrex Swift R2 GTX', price: 135.00 },
    { name: 'Merrell Moab 2', price: 120.00 }
];
